        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-5 lg:space-y-6 max-w-xl">
              ...
              {/* Breadcrumb */}
              <nav 
                className={`contact-reveal flex items-center gap-2 text-sm text-gray-500 ${isLoaded ? 'visible' : ''}`}
              ...
              {/* Badge with glow */}
              <div 
                className={`contact-reveal ${isLoaded ? 'visible' : ''}`}
              ...
              >
                ...
                >
                  <svg className="w-4 h-4 text-[#376eb5]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="relative">
                <h1 
                  className={`contact-reveal font-serif text-4xl sm:text-5xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-[1.1] tracking-tight ${isLoaded ? 'visible' : ''}`}
              ...
              {/* Description */}
              <p 
                className={`contact-reveal text-lg lg:text-xl text-gray-600 leading-relaxed pt-4 ${isLoaded ? 'visible' : ''}`}
            ...
            <div 
              className={`contact-reveal relative h-[350px] sm:h-[400px] lg:h-[480px] xl:h-[520px] ${isLoaded ? 'visible' : ''}`}
              style={{ transitionDelay: '0.3s' }}
            >
              ...
              <div 
                className={`contact-reveal absolute bottom-[15%] lg:bottom-[12%] right-[5%] lg:right-[8%] z-30 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg ${isLoaded ? 'visible' : ''}`}
