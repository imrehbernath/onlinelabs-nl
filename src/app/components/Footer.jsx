...
export default function Footer({ footerData }) {
  ...
  const footer = footerData || {
    ...
    services: [
      { title: 'SEO Optimalisatie', url: '/diensten/seo' },
      { title: 'GEO Optimalisatie', url: '/diensten/geo' },
      { title: 'Google Ads', url: '/diensten/google-ads' },
      { title: 'Webdesign', url: '/diensten/webdesign' },
      { title: 'WordPress Development', url: '/diensten/wordpress' },
    ],
    
    company: [
      { title: 'Over OnlineLabs', url: '/over-ons' },
    ...
    contact: {
      ...
      email: 'info@onlinelabs.nl',
      phone: '+31 (0)20 123 4567',
    },
    
    social: [
      { name: 'LinkedIn', url: 'https://linkedin.com/company/onlinelabs', icon: 'linkedin' },
      { name: 'Twitter', url: 'https://twitter.com/onlinelabs', icon: 'twitter' },
      { name: 'Facebook', url: 'https://facebook.com/onlinelabs', icon: 'facebook' },
      { name: 'Instagram', url: 'https://instagram.com/onlinelabs', icon: 'instagram' },
    ],
  };
      ...
      <div className="container mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              <a
                href="https://www.google.com/partners/agency?id=6419018951"
                target="_blank"
