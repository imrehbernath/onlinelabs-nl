    ...
    <section className={`${gradients[variant]} py-16 lg:py-20 relative overflow-hidden`}>
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Trust indicators - RECHT ONDER ELKAAR LINKS UITGELIJND */}
          <div className="mt-8 lg:mt-10 flex justify-center">
            <div className="inline-flex flex-col lg:flex-row lg:flex-wrap lg:justify-center items-start lg:items-center gap-3 lg:gap-8 text-sm text-white/80">
