        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          <div className="grid grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className={headings.length > 0 ? 'col-span-12 lg:col-span-8' : 'col-span-12 max-w-3xl mx-auto'}>
              ...
              {/* Website Calculator - alleen voor wat-kost-een-website-laten-bouwen */}
              {resolvedParams.slug === 'wat-kost-een-website-laten-bouwen' && (
                <div className="mt-12">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">
                      Krijg binnen 2 minuten een realistische prijsindicatie voor jouw project
                    </p>
                  </div>
                  <WebsiteCalculator />
                </div>
