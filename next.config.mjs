...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      {
        protocol: 'https',
        hostname: 'cdn.onlinelabs.nl', // Primary CDN (Cloudways via CNAME)
      },
      {
        protocol: 'https',
        hostname: 'wordpress-988065-5984089.cloudwaysapps.com', // Development/fallback
      },
      {
        protocol: 'https',
    ...
    return [
      {
        ...
        has: [
          {
            type: 'host',
            value: 'www.onlinelabs.nl',
          },
        ],
        destination: 'https://onlinelabs.nl/:path*',
        permanent: true,
      },
    ];
  },
